 ...
 */
      ...
      public:
         ...
         typedef Callback<void, Ptr<const Packet> > MacTxFinishedCallback;
         /**
  ...
  */
   ...
   */
         ...
         void SetTxFinishedCallback (MacTxFinishedCallback callback);
  ...
  */
   ...
   */
      ...
      MacTxFinishedCallback m_txFinishedCallback;

      private:
         Ptr<TDMALorawanRTC> m_rtc;
         uint32_t m_node_id;
      };
